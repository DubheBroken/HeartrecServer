...
public class AcceptMissionList extends HttpServlet {
	
	private static final String TABLE_NAME = "mission_info";
	/**
	 * Constructor of the object.
	 */
	public AcceptMissionList() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html;charset=gbk");
	        PrintWriter out = response.getWriter();  
	        ResultSet rs = null;
	        String accepter_str = request.getParameter("aml_accepter");
	        String result=null;
		        try  
		        {  
				...
				try {
					String sql="select count(*) count from "+TABLE_NAME+" where mission_accepter='"+accepter_str+"';";//ֻ��ѯ���������Լ�������
					rs = stmt.executeQuery(sql);  //ִ�����
					rs.next();
					int count = rs.getInt("count");
					result = Integer.toString(count);
					if(count>0){
						sql="select * from "+TABLE_NAME+" where mission_publisher='"+accepter_str+"';";//ֻ��ѯ���������Լ�������
						rs = stmt.executeQuery(sql);  //ִ�����
						while(rs.next()){
							...
							result += ","+ rs.getString("mission_publisher");
